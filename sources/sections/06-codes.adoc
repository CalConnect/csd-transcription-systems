...
For example, <<ISO639>> contains multiple parts where language codes can be selected from.
...
[example]
`2013` is the edition year of the system coded as `un-lao-laoo-latn-2013`.
...
* Two-character authority codes are reserved for <<ISO3166>> codes, which designate that the authority
is the government that is represented by the particular <<ISO3166>> code.
