...
A code for a script conversion system has the structure of a list, with all
elements joined by a dash character (`-`, Unicode U+2012).
...
by a dash character (`-`, Unicode U+2012).
