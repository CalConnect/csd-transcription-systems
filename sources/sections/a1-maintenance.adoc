...
- method identifier (TODO: or method number?) of the conversion system
...
will appoint an advisory group of up to 11 _?_ members. (TODO: discuss good number)
...
[[reservation]]
=== Reservation of code elements (TODO: discuss)
