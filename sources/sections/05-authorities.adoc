...
If a script conversion system authority no longer ceases to exist,
it is considered "`inactive`" and <<scsa-requirements-b>> no longer
applies.

If a script conversion system authority is "`inactive`",
...
* Codes with 2 letters are reserved for ISO 3166 codes, each representing the administration authority of the particular jurisdiction.
